...
m0.glm <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~1, data = redges,
                           family = stats::binomial(link = "logit"), REML = FALSE)
m0.glmer <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~(1|manager_id), data = redges,
                             family = stats::binomial(link = "logit"), REML = FALSE)
...
Cand.mod[[1]] <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~1 + (1|manager_id), data = redges,
                                  family = stats::binomial(link = "logit"), REML = FALSE)
...
Cand.mod[[2]] <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~log2(distance+1) + (1|manager_id), data = redges,
                                  family = stats::binomial(link = "logit"), REML = FALSE)
...
Cand.mod[[3]] <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~add_control + (1|manager_id), data = redges,
                                  family = stats::binomial(link = "logit"), REML = FALSE)
...
Cand.mod[[4]] <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~obstacles + (1|manager_id), data = redges,
                                  family = stats::binomial(link = "logit"), REML = FALSE)
...
Cand.mod[[5]] <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~pb_fixation + (1|manager_id), data = redges,
                                  family = stats::binomial(link = "logit"), REML = FALSE)
...
Cand.mod[[6]] <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~slope + (1|manager_id), data = redges,
                                  family = stats::binomial(link = "logit"), REML = FALSE)
...
Cand.mod[[7]] <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~log2(stand_surface) + (1|manager_id), data = redges,
                                  family = stats::binomial(link = "logit"), REML = FALSE)
...
Cand.mod[[8]] <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~tarping_duration + (1|manager_id), data = redges,
                                  family = stats::binomial(link = "logit"), REML = FALSE)
...
Cand.mod[[9]] <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~log2(trench_depth+1) + (1|manager_id), data = redges,
                                  family = stats::binomial(link = "logit"), REML = FALSE)
...
Cand.mod[[10]] <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~log2(distance+1) + add_control + (1|manager_id), data = redges,
                                   family = stats::binomial(link = "logit"), REML = FALSE)
...
Cand.mod[[11]] <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~log2(distance+1) + obstacles + (1|manager_id), data = redges,
                                   family = stats::binomial(link = "logit"), REML = FALSE)
...
Cand.mod[[12]] <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~log2(distance+1) + repairs + (1|manager_id), data = redges,
                                   family = stats::binomial(link = "logit"), REML = FALSE)
...
Cand.mod[[13]] <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~log2(distance+1) + pb_fixation + (1|manager_id), data = redges,
                                   family = stats::binomial(link = "logit"), REML = FALSE)
...
Cand.mod[[14]] <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~log2(distance+1) + log2(stand_surface) + (1|manager_id), data = redges,
                                   family = stats::binomial(link = "logit"), REML = FALSE)
...
Cand.mod[[15]] <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~log2(distance+1) + geomem + (1|manager_id), data = redges,
                                   family = stats::binomial(link = "logit"), REML = FALSE)
...
Cand.mod[[16]] <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~log2(distance+1) + tarping_duration + (1|manager_id), data = redges,
                                   family = stats::binomial(link = "logit"), REML = FALSE)
...
Cand.mod[[17]] <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~log2(distance+1) + log2(trench_depth+1) + (1|manager_id), data = redges,
                                   family = stats::binomial(link = "logit"), REML = FALSE)
...
Cand.mod[[18]] <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~log2(distance+1) * log2(trench_depth+1) + (1|manager_id), data = redges,
                                   family = stats::binomial(link = "logit"), REML = FALSE)
...
Cand.mod[[19]] <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~log2(trench_depth+1) + add_control + (1|manager_id), data = redges,
                                   family = stats::binomial(link = "logit"), REML = FALSE)
...
Cand.mod[[20]] <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~log2(trench_depth+1) + obstacles + (1|manager_id), data = redges,
                                   family = stats::binomial(link = "logit"), REML = FALSE)
...
Cand.mod[[21]] <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~log2(trench_depth+1) + log2(stand_surface) + (1|manager_id), data = redges,
                                   family = stats::binomial(link = "logit"), REML = FALSE)
...
Cand.mod[[22]] <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~log2(stand_surface) + add_control + (1|manager_id), data = redges,
                                   family = stats::binomial(link = "logit"), REML = FALSE)
...
Cand.mod[[23]] <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~log2(stand_surface) + obstacles + (1|manager_id), data = redges,
                                   family = stats::binomial(link = "logit"), REML = FALSE)
...
Cand.mod[[24]] <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~log2(stand_surface) + pb_fixation + (1|manager_id), data = redges,
                                   family = stats::binomial(link = "logit"), REML = FALSE)
...
Cand.mod[[25]] <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~log2(stand_surface) + tarping_duration + (1|manager_id), data = redges,
                                   family = stats::binomial(link = "logit"), REML = FALSE)
...
Cand.mod[[26]] <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~log2(trench_depth+1) + repairs + (1|manager_id), data = redges,
                                   family = stats::binomial(link = "logit"), REML = FALSE)
...
Cand.mod[[27]] <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~log2(trench_depth+1) + slope + (1|manager_id), data = redges,
                                   family = stats::binomial(link = "logit"), REML = FALSE)
...
Cand.mod[[28]] <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~add_control + obstacles + (1|manager_id), data = redges,
                                   family = stats::binomial(link = "logit"), REML = FALSE)
...
Cand.mod[[29]] <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~add_control + pb_fixation + (1|manager_id), data = redges,
                                   family = stats::binomial(link = "logit"), REML = FALSE)
...
Cand.mod[[30]] <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~add_control + slope + (1|manager_id), data = redges,
                                   family = stats::binomial(link = "logit"), REML = FALSE)
...
Cand.mod[[31]] <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~add_control + tarping_duration + (1|manager_id), data = redges,
                                   family = stats::binomial(link = "logit"), REML = FALSE)
...
Cand.mod[[32]] <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~obstacles + pb_fixation + (1|manager_id), data = redges,
                                   family = stats::binomial(link = "logit"), REML = FALSE)
...
Cand.mod[[33]] <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~obstacles + geomem + (1|manager_id), data = redges,
                                   family = stats::binomial(link = "logit"), REML = FALSE)
...
Cand.mod[[34]] <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~obstacles + repairs + (1|manager_id), data = redges,
                                   family = stats::binomial(link = "logit"), REML = FALSE)
...
Cand.mod[[35]] <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~slope + geomem + (1|manager_id), data = redges,
                                   family = stats::binomial(link = "logit"), REML = FALSE)
...
Cand.mod[[36]] <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~slope + pb_fixation + (1|manager_id), data = redges,
                                   family = stats::binomial(link = "logit"), REML = FALSE)
...
Cand.mod[[37]] <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~slope + tarping_duration + (1|manager_id), data = redges,
                                   family = stats::binomial(link = "logit"), REML = FALSE)
...
Cand.mod[[38]] <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~log2(distance+1) + log2(trench_depth+1) + add_control
...
Cand.mod[[39]] <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~log2(distance+1) + log2(trench_depth+1) + obstacles
                                   + (1|manager_id), data = redges, family = stats::binomial(link = "logit"),
                                   REML = FALSE)
...
Cand.mod[[40]] <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~log2(distance+1) + log2(trench_depth+1) + geomem
                                   + (1|manager_id), data = redges, family = stats::binomial(link = "logit"),
                                   REML = FALSE)
...
Cand.mod[[41]] <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~log2(distance+1) + log2(trench_depth+1) + log2(stand_surface)
                                   + (1|manager_id), data = redges, family = stats::binomial(link = "logit"),
                                   REML = FALSE)
...
Cand.mod[[42]] <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~log2(distance+1) + log2(trench_depth+1) + slope
                                   + (1|manager_id), data = redges, family = stats::binomial(link = "logit"),
                                   REML = FALSE)
...
Cand.mod[[43]] <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~log2(distance+1) + log2(stand_surface) + add_control
                                   + (1|manager_id), data = redges, family = stats::binomial(link = "logit"),
                                   REML = FALSE)
...
Cand.mod[[44]] <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~log2(distance+1) + log2(stand_surface) + obstacles
                                   + (1|manager_id), data = redges, family = stats::binomial(link = "logit"),
                                   REML = FALSE)
...
Cand.mod[[45]] <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~log2(distance+1) + log2(stand_surface) + pb_fixation
                                   + (1|manager_id), data = redges, family = stats::binomial(link = "logit"),
                                   REML = FALSE)
...
Cand.mod[[46]] <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~log2(distance+1) + geomem + tarping_duration
                                   + (1|manager_id), data = redges, family = stats::binomial(link = "logit"),
                                   REML = FALSE)
...
Cand.mod[[47]] <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~log2(stand_surface) + log2(trench_depth+1) + obstacles
                                   + (1|manager_id), data = redges, family = stats::binomial(link = "logit"),
                                   REML = FALSE)
...
Cand.mod[[48]] <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~log2(stand_surface) + log2(trench_depth+1) + slope
                                   + (1|manager_id), data = redges, family = stats::binomial(link = "logit"),
                                   REML = FALSE)
...
Cand.mod[[49]] <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~log2(distance+1) + tarping_duration + add_control
                                   + (1|manager_id), data = redges, family = stats::binomial(link = "logit"),
                                   REML = FALSE)
...
Cand.mod[[50]] <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~obstacles + repairs + add_control
                                   + (1|manager_id), data = redges, family = stats::binomial(link = "logit"),
                                   REML = FALSE)
...
Cand.mod[[51]] <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~obstacles + add_control + geomem
                                   + (1|manager_id), data = redges, family = stats::binomial(link = "logit"),
                                   REML = FALSE)
...
Cand.mod[[52]] <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~obstacles + add_control + tarping_duration
                                   + (1|manager_id), data = redges, family = stats::binomial(link = "logit"),
                                   REML = FALSE)
...
Cand.mod[[53]] <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~obstacles + add_control + log2(trench_depth+1)
                                   + (1|manager_id), data = redges, family = stats::binomial(link = "logit"),
                                   REML = FALSE)
...
Cand.mod[[54]] <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~obstacles + add_control + log2(stand_surface)
                                   + (1|manager_id), data = redges, family = stats::binomial(link = "logit"),
                                   REML = FALSE)
...
Cand.mod[[55]] <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~obstacles + add_control + slope
                                   + (1|manager_id), data = redges, family = stats::binomial(link = "logit"),
                                   REML = FALSE)
...
Cand.mod[[56]] <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~log2(trench_depth+1) + log2(distance+1) + repairs
                                   + (1|manager_id), data = redges, family = stats::binomial(link = "logit"),
                                   REML = FALSE)
...
Cand.mod[[57]] <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~log2(trench_depth+1) + obstacles + repairs
                                   + (1|manager_id), data = redges, family = stats::binomial(link = "logit"),
                                   REML = FALSE)
...
Cand.mod[[58]] <- glmmTMB::glmmTMB(formula = lreg_tarpedarea~log2(trench_depth+1) + obstacles + geomem
                                   + (1|manager_id), data = redges, family = stats::binomial(link = "logit"),
                                   REML = FALSE)
