...
# #   "manager_id", "xp_id", "reg_stripsoverlap",
...
# readr::read_csv(here::here("mydata", "roverlaps.csv"), col_names = TRUE, col_types =
#                   readr::cols(
...
### Table export:
readr::write_csv2(x = Parameter.model, file = here::here("output", "tables", "Param.full.reg_stripsoverlap.csv"))
