...
# # -----------------
#
# Cand.mod[[2]] <- glmmTMB::glmmTMB(formula = efficiency~log2(distance+1), data = eff,
#                                   family = glmmTMB::beta_family(link = "logit"), REML = FALSE)
#
...
# # -----------------
#
# Cand.mod[[9]] <- glmmTMB::glmmTMB(formula = efficiency~log2(sedicover_height+1), data = eff,
#                                   family = glmmTMB::beta_family(link = "logit"), REML = FALSE)
#
# ### Model evaluation (Fluttersbys method):
...
# # -----------------
#
# Cand.mod[[11]] <- glmmTMB::glmmTMB(formula = efficiency~log2(stand_surface), data = eff,
#                                    family = glmmTMB::beta_family(link = "logit"), REML = FALSE)
#
# ### Model evaluation (Fluttersbys method):
...
# # -----------------
#
# Cand.mod[[12]] <- glmmTMB::glmmTMB(formula = efficiency~log2(tarping_duration), data = eff,
#                                    family = glmmTMB::beta_family(link = "logit"), REML = FALSE)
#
# ### Model evaluation (Fluttersbys method):
...
Cand.mod[[2]] <- glmmTMB::glmmTMB(formula = efficiency~log2(distance+1) + followups, data = eff,
                                   family = glmmTMB::beta_family(link = "logit"), REML = FALSE)
...
Cand.mod[[3]] <- glmmTMB::glmmTMB(formula = efficiency~log2(distance+1) + fully_tarped, data = eff,
                                   family = glmmTMB::beta_family(link = "logit"), REML = FALSE)
...
Cand.mod[[4]] <- glmmTMB::glmmTMB(formula = efficiency~log2(distance+1) + obstacles, data = eff,
                                   family = glmmTMB::beta_family(link = "logit"), REML = FALSE)
...
Cand.mod[[5]] <- glmmTMB::glmmTMB(formula = efficiency~log2(distance+1) + log2(stand_surface), data = eff,
                                   family = glmmTMB::beta_family(link = "logit"), REML = FALSE)
...
Cand.mod[[6]] <- glmmTMB::glmmTMB(formula = efficiency~log2(distance+1) + log2(sedicover_height+1), data = eff,
                                   family = glmmTMB::beta_family(link = "logit"), REML = FALSE)
...
Cand.mod[[7]] <- glmmTMB::glmmTMB(formula = efficiency~log2(distance+1) + uprootexcav, data = eff,
                                   family = glmmTMB::beta_family(link = "logit"), REML = FALSE)
...
Cand.mod[[8]] <- glmmTMB::glmmTMB(formula = efficiency~followups + fully_tarped, data = eff,
                                   family = glmmTMB::beta_family(link = "logit"), REML = FALSE)
...
Cand.mod[[9]] <- glmmTMB::glmmTMB(formula = efficiency~followups + pb_fixation, data = eff,
                                   family = glmmTMB::beta_family(link = "logit"), REML = FALSE)
...
Cand.mod[[10]] <- glmmTMB::glmmTMB(formula = efficiency~followups + obstacles, data = eff,
                                   family = glmmTMB::beta_family(link = "logit"), REML = FALSE)
...
Cand.mod[[11]] <- glmmTMB::glmmTMB(formula = efficiency~followups + log2(stand_surface), data = eff,
                                   family = glmmTMB::beta_family(link = "logit"), REML = FALSE)
...
Cand.mod[[12]] <- glmmTMB::glmmTMB(formula = efficiency~followups + log2(tarping_duration), data = eff,
                                   family = glmmTMB::beta_family(link = "logit"), REML = FALSE)
...
Cand.mod[[13]] <- glmmTMB::glmmTMB(formula = efficiency~fully_tarped + geomem, data = eff,
                                   family = glmmTMB::beta_family(link = "logit"), REML = FALSE)
...
Cand.mod[[14]] <- glmmTMB::glmmTMB(formula = efficiency~fully_tarped + pb_fixation, data = eff,
                                   family = glmmTMB::beta_family(link = "logit"), REML = FALSE)
...
Cand.mod[[15]] <- glmmTMB::glmmTMB(formula = efficiency~fully_tarped + log2(sedicover_height+1), data = eff,
                                   family = glmmTMB::beta_family(link = "logit"), REML = FALSE)
...
Cand.mod[[16]] <- glmmTMB::glmmTMB(formula = efficiency~fully_tarped + log2(stand_surface), data = eff,
                                   family = glmmTMB::beta_family(link = "logit"), REML = FALSE)
...
Cand.mod[[17]] <- glmmTMB::glmmTMB(formula = efficiency~fully_tarped + obstacles, data = eff,
                                   family = glmmTMB::beta_family(link = "logit"), REML = FALSE)
...
Cand.mod[[18]] <- glmmTMB::glmmTMB(formula = efficiency~fully_tarped + log2(tarping_duration), data = eff,
                                   family = glmmTMB::beta_family(link = "logit"), REML = FALSE)
...
Cand.mod[[19]] <- glmmTMB::glmmTMB(formula = efficiency~log2(stand_surface) + geomem, data = eff,
                                   family = glmmTMB::beta_family(link = "logit"), REML = FALSE)
...
Cand.mod[[20]] <- glmmTMB::glmmTMB(formula = efficiency~log2(stand_surface) + obstacles, data = eff,
                                   family = glmmTMB::beta_family(link = "logit"), REML = FALSE)
...
Cand.mod[[21]] <- glmmTMB::glmmTMB(formula = efficiency~log2(stand_surface) + plantation, data = eff,
                                   family = glmmTMB::beta_family(link = "logit"), REML = FALSE)
...
Cand.mod[[22]] <- glmmTMB::glmmTMB(formula = efficiency~log2(stand_surface) + slope, data = eff,
                                   family = glmmTMB::beta_family(link = "logit"), REML = FALSE)
...
Cand.mod[[23]] <- glmmTMB::glmmTMB(formula = efficiency~log2(stand_surface) + log2(tarping_duration), data = eff,
                                   family = glmmTMB::beta_family(link = "logit"), REML = FALSE)
...
Cand.mod[[24]] <- glmmTMB::glmmTMB(formula = efficiency~pb_fixation + obstacles, data = eff,
                                   family = glmmTMB::beta_family(link = "logit"), REML = FALSE)
...
Cand.mod[[25]] <- glmmTMB::glmmTMB(formula = efficiency~uprootexcav + geomem, data = eff,
                                   family = glmmTMB::beta_family(link = "logit"), REML = FALSE)
...
Cand.mod[[26]] <- glmmTMB::glmmTMB(formula = efficiency~uprootexcav + plantation, data = eff,
                                   family = glmmTMB::beta_family(link = "logit"), REML = FALSE)
...
Cand.mod[[27]] <- glmmTMB::glmmTMB(formula = efficiency~obstacles + plantation, data = eff,
                                   family = glmmTMB::beta_family(link = "logit"), REML = FALSE)
...
Cand.mod[[28]] <- glmmTMB::glmmTMB(formula = efficiency~obstacles + slope, data = eff,
                                   family = glmmTMB::beta_family(link = "logit"), REML = FALSE)
...
Cand.mod[[29]] <- glmmTMB::glmmTMB(formula = efficiency~log2(distance+1) + fully_tarped + followups, data = eff,
                                   family = glmmTMB::beta_family(link = "logit"), REML = FALSE)
...
Cand.mod[[30]] <- glmmTMB::glmmTMB(formula = efficiency~log2(distance+1) + fully_tarped + geomem, data = eff,
                                   family = glmmTMB::beta_family(link = "logit"), REML = FALSE)
...
Cand.mod[[31]] <- glmmTMB::glmmTMB(formula = efficiency~log2(distance+1) + fully_tarped + obstacles, data = eff,
                                   family = glmmTMB::beta_family(link = "logit"), REML = FALSE)
...
Cand.mod[[32]] <- glmmTMB::glmmTMB(formula = efficiency~log2(distance+1) + fully_tarped + plantation, data = eff,
                                   family = glmmTMB::beta_family(link = "logit"), REML = FALSE)
...
Cand.mod[[33]] <- glmmTMB::glmmTMB(formula = efficiency~log2(distance+1) + fully_tarped + pb_fixation, data = eff,
                                   family = glmmTMB::beta_family(link = "logit"), REML = FALSE)
...
Cand.mod[[34]] <- glmmTMB::glmmTMB(formula = efficiency~log2(distance+1) + fully_tarped + slope, data = eff,
                                   family = glmmTMB::beta_family(link = "logit"), REML = FALSE)
...
Cand.mod[[35]] <- glmmTMB::glmmTMB(formula = efficiency~log2(distance+1) + fully_tarped + log2(sedicover_height+1), data = eff,
                                   family = glmmTMB::beta_family(link = "logit"), REML = FALSE)
...
Cand.mod[[36]] <- glmmTMB::glmmTMB(formula = efficiency~log2(distance+1) + fully_tarped + log2(stand_surface), data = eff,
                                   family = glmmTMB::beta_family(link = "logit"), REML = FALSE)
...
Cand.mod[[37]] <- glmmTMB::glmmTMB(formula = efficiency~log2(distance+1) + fully_tarped + log2(tarping_duration), data = eff,
                                   family = glmmTMB::beta_family(link = "logit"), REML = FALSE)
...
Cand.mod[[38]] <- glmmTMB::glmmTMB(formula = efficiency~log2(distance+1) + pb_fixation + followups, data = eff,
                                   family = glmmTMB::beta_family(link = "logit"), REML = FALSE)
...
Cand.mod[[39]] <- glmmTMB::glmmTMB(formula = efficiency~log2(distance+1) + log2(stand_surface) + followups, data = eff,
                                   family = glmmTMB::beta_family(link = "logit"), REML = FALSE)
...
Cand.mod[[40]] <- glmmTMB::glmmTMB(formula = efficiency~log2(distance+1) + log2(stand_surface) + obstacles, data = eff,
                                   family = glmmTMB::beta_family(link = "logit"), REML = FALSE)
...
Cand.mod[[41]] <- glmmTMB::glmmTMB(formula = efficiency~log2(distance+1) + log2(stand_surface) + pb_fixation, data = eff,
                                   family = glmmTMB::beta_family(link = "logit"), REML = FALSE)
...
Cand.mod[[42]] <- glmmTMB::glmmTMB(formula = efficiency~fully_tarped + pb_fixation + followups, data = eff,
                                   family = glmmTMB::beta_family(link = "logit"), REML = FALSE)
...
Cand.mod[[43]] <- glmmTMB::glmmTMB(formula = efficiency~fully_tarped + log2(stand_surface) + geomem, data = eff,
                                   family = glmmTMB::beta_family(link = "logit"), REML = FALSE)
...
Cand.mod[[44]] <- glmmTMB::glmmTMB(formula = efficiency~fully_tarped + log2(stand_surface) + followups, data = eff,
                                   family = glmmTMB::beta_family(link = "logit"), REML = FALSE)
...
Cand.mod[[45]] <- glmmTMB::glmmTMB(formula = efficiency~fully_tarped + log2(stand_surface) + pb_fixation, data = eff,
                                   family = glmmTMB::beta_family(link = "logit"), REML = FALSE)
...
Cand.mod[[46]] <- glmmTMB::glmmTMB(formula = efficiency~fully_tarped + log2(stand_surface) + log2(sedicover_height+1), data = eff,
                                   family = glmmTMB::beta_family(link = "logit"), REML = FALSE)
...
Cand.mod[[47]] <- glmmTMB::glmmTMB(formula = efficiency~fully_tarped + log2(stand_surface) + slope, data = eff,
                                   family = glmmTMB::beta_family(link = "logit"), REML = FALSE)
...
Cand.mod[[48]] <- glmmTMB::glmmTMB(formula = efficiency~fully_tarped + log2(stand_surface) + uprootexcav, data = eff,
                                   family = glmmTMB::beta_family(link = "logit"), REML = FALSE)
...
Cand.mod[[49]] <- glmmTMB::glmmTMB(formula = efficiency~fully_tarped + log2(stand_surface) + log2(tarping_duration), data = eff,
                                   family = glmmTMB::beta_family(link = "logit"), REML = FALSE)
...
Cand.mod[[50]] <- glmmTMB::glmmTMB(formula = efficiency~fully_tarped + followups + geomem, data = eff,
                                   family = glmmTMB::beta_family(link = "logit"), REML = FALSE)
...
Cand.mod[[51]] <- glmmTMB::glmmTMB(formula = efficiency~fully_tarped + followups + obstacles, data = eff,
                                   family = glmmTMB::beta_family(link = "logit"), REML = FALSE)
...
Cand.mod[[52]] <- glmmTMB::glmmTMB(formula = efficiency~plantation + pb_fixation + slope, data = eff,
                                   family = glmmTMB::beta_family(link = "logit"), REML = FALSE)
...
Cand.mod[[53]] <- glmmTMB::glmmTMB(formula = efficiency~fully_tarped + obstacles + pb_fixation, data = eff,
                                   family = glmmTMB::beta_family(link = "logit"), REML = FALSE)
...
Cand.mod[[54]] <- glmmTMB::glmmTMB(formula = efficiency~fully_tarped + obstacles + slope, data = eff,
                                   family = glmmTMB::beta_family(link = "logit"), REML = FALSE)
...
Cand.mod[[55]] <- glmmTMB::glmmTMB(formula = efficiency~fully_tarped + obstacles + uprootexcav, data = eff,
                                   family = glmmTMB::beta_family(link = "logit"), REML = FALSE)
