...
* *stripfix_pierced* is strongly positively correlated with *tarpfix_pierced*, but also with *fully_tarped*,  and negatively with *repairs*.
* *stripfix_taped* is mildly positively correlated with *maxveg*, and negatively with *add_control*, and *reg_elsewhere*. 
* Conversely, *strips_overlap* is mildly negatively correlated with *repairs* and *pb_durability*. 
...
* *reg_elsewhere* is also negatively correlated with *maxveg* and *trench_depth*, and positively with *add_control*, all these correlations seeming quite logical. 
...
* The *distance*, *sedicover_height*, *trench_depth*, and *freq_monitoring* variables may require important transformations to be normalized. 
...
* Second, *reg_stripsoverlap* seems to increase with increasing *add_control*, *coarse_env*, *elevation*, *freq_monitoring*, *geomem*, *reg_elsewhere*, *sedicover_height*, and *slope*. If some relationships seem quite straightforward (and are in accordance with our hypotheses), others are more surprising and may just be noise. 
...
1) Set drake + co-plots? + ask questions SO/CV !!!
