...
* We selected the subset of predictors and covariates that will be used to model tarping's efficiency;
...
* We also deleted an outlier (spotted thanks to subsequent exploration) which had a stand surface of 5000 m^2^.
