---
title: "Data Preparation Report - Knotweed's Tarping Survey (Martin *et al.*, 2021)"
...
```{r erad followups, warning=FALSE, fig.align='center', fig.cap="**Figure 2.1b.** Correlation plot of the normed-PCA on follow-up variables for the *tarping efficiency* dataset"}
...
```{r erad bivariate plot2, fig.align='center', fig.cap="**Figure 2.6b.** Multivariate representation of the *efficiency score* against each potential explanatory variable with a focus on whether knotweed stands were fully tarped or not", fig.width=12, fig.height=9, message=FALSE, comment=NA, warning=FALSE}
erad %>% dplyr::select(-manager_id, -xp_id, -goals, -eff_eradication, -high_eff) %>%
  dplyr::mutate_if(is.factor, as.numfactor) %>% 
...
```{r erad cond.boxplots, fig.align='center', fig.cap="**Figure 2.7.** Bivariate conditional boxplots of the *efficiency score* against each potential explanatory variable", fig.width=9, fig.height=7, message=FALSE, comment=NA, warning=FALSE}
...
```{r erad coplot 3, fig.align='center', fig.cap="**Figure 2.8c.** Coplot of the *efficiency score* displaying a two-way interaction between *followups* and *pb_fixation*. There is a 5% overlap between each group, explaining why there are more than *n* = 85 points. Colours are meaningless and are just here for aesthetical reasons", message=FALSE, comment=NA, warning=FALSE}
...
```
```{r erad coplot 4, fig.align='center', fig.cap="**Figure 2.8d.** Coplot of the *efficiency score* displaying a two-way interaction between *followups* and *pb_durability*. There is a 5% overlap between each group, explaining why there are more than *n* = 85 points. Colours are meaningless and are just here for aesthetical reasons", message=FALSE, comment=NA, warning=FALSE}
...
```{r redges followups, warning=FALSE, fig.align='center', fig.cap="**Figure 3.1b.** Correlation plot of the normed-PCA on follow-up variables for the *tarping efficiency* dataset"}
...
```{r redges coplot 2, fig.align='center', fig.cap="**Figure 3.7b.** Conditioning spineplot of *lreg_edges* displaying a two-way interaction between *slope* and *obstacles*. Within each panel, the proportion of operations that found knotweed regrowths at the edge of the tarped area (dark orange) and the proportion of those that did not (light orange) is displayed while left-hand rectangles display these proportions for *gentle* slopes (below average) and right-hand rectangles display them for *steep* slopes (above average)", message=FALSE, comment=NA, warning=FALSE}
...
```{r redges coplot 4, fig.align='center', fig.cap="**Figure 3.7d.** Conditioning spineplot of *lreg_edges* displaying a two-way interaction between *obstacles* and *distance*. Within each panel, the proportion of operations that found knotweed regrowths at the edge of the tarped area (dark orange) and the proportion of those that did not (light orange) is displayed while left-hand rectangles display these proportions for *low* obstacle proportions (below average) and right-hand rectangles display them for *high* obstacle proportions (above average)", message=FALSE, comment=NA, warning=FALSE}
...
```{r rtarped followups, warning=FALSE, fig.align='center', fig.cap="**Figure 4.1b.** Correlation plot of the normed-PCA on follow-up variables for the *tarping efficiency* dataset"}
...
```{r roverlaps followups, warning=FALSE, fig.align='center', fig.cap="**Figure 1b.** Correlation plot of the normed-PCA on follow-up variables for the *tarping efficiency* dataset"}
...
# - Next steps (c'est mon pense-bête)
