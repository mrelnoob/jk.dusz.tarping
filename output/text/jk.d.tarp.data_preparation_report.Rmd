...
For variables where doubt subsists regarding the *extremeness* of some values, we will simulate data with Normal and Poisson distributions with the parameters of our variables to determine if these values are *too extreme* to be benign in models.
