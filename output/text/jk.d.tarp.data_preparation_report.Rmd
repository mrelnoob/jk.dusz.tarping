...
par(mfrow= c (4,4), mar=c(0.5,4,1.5,0.5), cex.lab = 1.3, bty = "n", col.axis = "gray15", cex = 0.9)
for (i in c(1:ncol(num.erad))) {
  boxplot(num.erad[,i],ylab =(nam[i]), type = "n", border = "lightsalmon4", col = "lightsalmon", pch = 19) }
...
* The variables *latitude*, *longitude*, and *stand_surface* contain problematic patterns/outliers. As latitude and longitude are supposed to be used as ***random effects*** in our models, I do not know what would the consequences of extreme values BLABLABLA§§§§§§§§§
